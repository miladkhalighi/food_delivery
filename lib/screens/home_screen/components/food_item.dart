...
class _FoodItemState extends State<FoodItem>
  ...
  void initState() {
    ...
    _rotate = Tween<double>(begin: 0,end: 1.5).animate(CurvedAnimation(parent: _animationCtr, curve: const Interval(0, 0.7,curve: Curves.easeIn)));
    _fadeAndScale = CurvedAnimation(parent: _animationCtr, curve: const Interval(0, 1,curve: Curves.easeIn),reverseCurve: Curves.easeOut);
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: Theme.of(context).textTheme.bodyText1?.copyWith(
                              fontSize: 18, color: SolidColors.primaryColor),
                          overflow: TextOverflow.ellipsis,
                        ),
                        SizedBox(
